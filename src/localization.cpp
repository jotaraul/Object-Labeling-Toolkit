...
{
    cout << endl << "-----------------------------------------------------" << endl;
    cout <<         "              Localize sensors app.                    " << endl;
    ...
    {
        CTicTac clock;
        double time_icp2D = 0, time_difodo = 0, time_icp3D = 0,
                time_smoothing = 0, time_overlapping = 0;
        ...
        cout << "    [INFO] time spent by difodo           : " << time_difodo << " sec." << endl;
