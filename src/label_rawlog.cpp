...
const double OFFSET_ANGLES = 0.02;
...
{
    m_labelColors["floor"] =    TPoint3D(1.0*0.0, 1.0*0.0, 1.0*0.0);
    ...
    m_labelColors["books"] =    TPoint3D(1.0*0.0, 1.0*0.0, 1.0*0.8);
    ...
    win3D.setWindowTitle("Rawlog labelling");
